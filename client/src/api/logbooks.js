...
export const rejectLogbook = (id, supervisorComment) =>
  api.patch(`/logbooks/${id}/reject`, { supervisorComment }).then((r) => r.data.data);
export const commentLogbook = (id, supervisorComment) =>
  api.patch(`/logbooks/${id}/comment`, { supervisorComment }).then((r) => r.data.data);
