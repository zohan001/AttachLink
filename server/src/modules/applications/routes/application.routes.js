 ...
 * /applications/my:
 *   get:
 *     summary: Get my applications (student)
 *     tags: [Applications]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *   get:
 *     summary: Get applications for my company
 *     tags: [Applications]
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: List of company applications
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/SuccessResponse'
...
/**
 * @swagger
 * /applications/company/{opportunityId}:
 *   get:
 *     summary: Get applications by opportunity (company)
 *     tags: [Applications]
 *     security:
 *       - bearerAuth: []
 *     parameters:
